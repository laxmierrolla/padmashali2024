        ...
        <div class="panel-body col-md-12">
          <div class="col-md-3 no-pad">
			   ...
			   if($profile_res->thumbimage!==""){ if($profile_res->Photoprotect == 1){
			    $profile_image =  $protect;
			   }else if($profile_res->Profile_photo_Status == 1){ 
          ...
          <div class="col-md-9 details-right">
            <div class="col-md-8">
            <h4><?php echo ucfirst($profile_res->fname); ?>&nbsp;<?php echo ucfirst($profile_res->lname); ?>.<?php echo ucfirst($profile_res->sname); ?>
          ...
          <ul class="list-inline">
              <?php
              $dateOfBirth = (isset($profile_res->dob))?$profile_res->dob:'';
				 $today = date("Y-m-d");
            ...
            <li><img src="<?php echo IMAGES_PATH; ?>working.png" alt="education" /><?php echo ucfirst($profile_res->occ_details); ?></li>
