              ...
              ?>
                  <aside class="sm-side">
                      ...
                      <ul class="inbox-nav inbox-divider">
							 ...
							 <li>
                              <ul class="nav nav-pills nav-stacked labels-danger inbox-divider">
                               <li > <a href="<?php echo base_url('userdashboard/inbox_pending');?>">Pending<span class="label label-info pull-right" id="pendingcounter"></span> </a> </li>
                                <li class="active"> <a href="<?php echo base_url('userdashboard/inbox_accepted');?>">Accepted<span class="label label-success pull-right" id="acceptcounter"></span> </a> </li>
                          ...
                          <li>
                              <a href="<?php echo base_url('userdashboard/trash');?>"><i class=" fa fa-trash-o"></i> Trash</a>
                          </li>
                      </ul>
                ...
                <?php } else{ ?>
                  <img src="<?php echo base_url().'uploads/profilepics/thumb/'.$img;?>" class="img-responsive" alt="User profile photo here" /> 
                            ...
                            <div class="col-md-9">
                               ...
                               <button disabled  value="<?php echo $row['profile_code']; ?>" class="btn btn-sm btn-hover btn-success btn-xs send_intesrest"  ><i class="fa fa-2x fa-thumbs-up" aria-hidden="true"></i> You are Accepted</button>&nbsp;&nbsp;
