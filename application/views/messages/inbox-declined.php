...
<body>
	...
	<div class="mail-box">
     <?php
							 ...
							 <li>
                              <ul class="nav nav-pills nav-stacked labels-danger inbox-divider">
                               <li> <a href="<?php echo base_url('userdashboard/inbox_pending');?>">Pending<span class="label label-info pull-right" id="pendingcounter"></span> </a> </li>
                                ...
                                <li class="active"> <a href="<?php echo base_url('userdashboard/inbox_declined');?>">Decline<span class="label label-danger pull-right" id="declinedcounter"></span> </a> </li>
                              </ul>
      ...
      <button  disabled value="<?php echo $row['profile_code']; ?>" class="btn btn-xs btn-hover btn-default decline"><i class="fa fa-2x fa-thumbs-down" aria-hidden="true"></i> Not Interested</button>
					...
					<?php } ?>
					  ...
					  <div class="col-md-12">
							  ...
							  <h4 class="text-center">No Declined Profiles. </h4>
