   ...
   <section class="content-header">
    ...
    <div class="box box-default">
        ...
        <div class="col-xs-12">
          ...
          <a class="btn btn-danger" style="display:none;" id="searchreset" href="<?php echo base_url('admin/marriedAccounts'); ?>"><li class="fa fa-search-minus"></li></a>   
            
          </form>  
             <input type="hidden" id="atpagination" value="">
            <input type="hidden" id="paginationlength" value="">
              <table id="marriedlist" class="table table-bordered table-striped">
...
$(document).ready(function(){
	var dtabel;
		...
		var search_on_1;
        var ispage;
	dtabel = $('#marriedlist').DataTable({
		 "processing": true,
        "serverSide": true,
        "bStateSave": true,
        "language": {
        //"lengthMenu": "Display _MENU_ records per page",
        "emptyTable": "No Married Accounts found!",
         },
       "sDom": "lptr<'clearfix'>p",
		...
		"ajax":{
			...
			"url": "<?php echo base_url('admin/allMarriedAcounts'); ?>",
            "type": "POST",
            "data": function (d) {
			...
			d.search_on_1 = search_on_1;
                ...
                "dataSrc": function (jsondata) {
                    ...
                    $("#marriedlist_length select").addClass('input-xs').removeClass('input-sm');
			 ...
			 "columns": [
				...
				{"title": "Profilecode", "name":"profile_code", "data":"profile_code", "width":"5%" },
    ...
    function setallvalues(){
        ...
        var table = $('#marriedlist').DataTable();
