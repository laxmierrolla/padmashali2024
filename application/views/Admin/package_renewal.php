    ...
    <section class="content">
         <div class="row"><!--  row -->
           <div class="box box-info">
            <!-- /.box-header -->
            <!-- form start -->
            <?php if(!empty($this->session->flashdata('renewl_error'))){ ?>
        ...
        <?php } ?>
         ...
         <?php if(!empty($this->session->flashdata('renewl_sucess'))){ ?>
           <div class="alert alert-success fade in">
                <a href="#" class="close" data-dismiss="alert">&times;</a>
               <strong>Success!</strong> Package reneweled successfully.
          </div>
        <?php } ?>
            <form class="form-horizontal" name="renwelform" id="renwelform" method="post" action="<?php echo base_url('admin/updatePackage');?>">
              <div class="box-body">
                ...
                </select><span class="package_error" style="color:red; display:none">Please select package</span>
                ...
                <input type="hidden" name="prfscode" id="prfscode" value="" />
                 <input type="hidden" name="oldvaliditydate" id="oldvaliditydate" value="" />
                   ...
                   <div class="col-sm-3">
                    <input class="btn btn-primary" type="submit"  name="upadte" id="upadte" value="UpdatePackage">
                  </div> 
                  <div class="col-sm-3">
	...
	$('.prfcode').click(function(){
		...
		$('#upadte').click(function(){
			...
			if(profilecode==""){
				...
				$('.package_error').fadeIn();
				setTimeout(function() {
					$('.package_error').fadeOut("slow");
				}, 3000 );
				return false;
				}
				else{
